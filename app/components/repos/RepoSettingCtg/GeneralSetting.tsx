...
export default function GeneralSetting({
  ...
  return (
    <>
      <div>
        <h2 className="text-2xl font-normal pb-4 border-b border-[#d0d7de]">General</h2>
        ...
        <div className="space-y-3 py-6 border-b border-[#d0d7de]">
          ...
          <div className="flex gap-3">
            <input 
              ...
              className="px-3 py-1.5 bg-[#f6f8fa] border border-[#d0d7de] rounded-md w-80 text-sm focus:outline-none focus:border-[#0969da] focus:ring-1 focus:ring-[#0969da]"
            />
            <button 
              onClick={handleRename}
              disabled={saving}
              className="px-4 py-1.5 bg-[#f6f8fa] border border-[#d0d7de] rounded-md font-medium text-sm hover:bg-[#f3f4f6] active:bg-[#edeff2] transition-colors cursor-pointer"
            >
        ...
        <div className="space-y-3 py-6 border-b border-[#d0d7de]">
          ...
          <div className="flex items-center gap-3">
            <div className="px-3 py-1.5 bg-[#f6f8fa] border border-[#d0d7de] rounded-md text-sm font-mono text-[#24292f] flex items-center gap-2">
              {defaultBranch}
            </div>
            <button className="p-2 bg-[#f6f8fa] border border-[#d0d7de] rounded-md hover:bg-[#f3f4f6] cursor-pointer">
